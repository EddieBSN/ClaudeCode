...
class TaskServiceTest(unittest.TestCase):
    ...
    def _create(self, title, description=""):
        return self.service.create(self.factory.new_task(title, description))

    def test_create_returns_task_with_id(self):
        task = self._create("Write tests", "cover the service")
    ...
    def test_update_changes_only_given_fields(self):
        created = self._create("original", "keep me")
    ...
    def test_delete_removes_task(self):
        created = self._create("temporary")
